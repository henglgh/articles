---
title: "DAOS 2.6.4：单节点集群部署"
date: 2024-12-09T16:48:44+0800
description: "本文详细介绍如何在almalinux 8.9上部署DAOS.2.6.4单节点集群（基于Metadata-on-SSD架构）。"
tags: [daos]
---
...
本文将详细介绍如何在 `almalinux 8.9` 上部署 DAOS 单机集群，配置方式采用 Metadata-on-SSD 模式，DAOS 版本为 `2.6.4`。
...
-------------------------------------------------------------------
[admin]          admin                192.168.3.10      node0
[server]         server               192.168.3.10      node0
[client]         client               192.168.3.10      node0
```
